...
//            pagingViewAttributes.frame = CGRect(x: 0, y: contentHeight, width: collectionView.frame.width, height: LoadingReusableView.height)
////            self.pagingViewAttributes = pagingViewAttributes
//
//           // contentHeight += LoadingReusableView.height
//        } else {
